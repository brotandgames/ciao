...
class ChecksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create check" do
    assert_difference('Check.count') do
      post checks_url, params: { check: { cron: @check.cron, description: @check.description, name: @check.name } }
    end
  ...
  test "should update check" do
    patch check_url(@check), params: { check: { cron: @check.cron, description: @check.description, name: @check.name } }
